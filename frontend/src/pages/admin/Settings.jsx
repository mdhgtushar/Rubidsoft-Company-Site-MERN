...
const Settings = () => {
  ...
  const [settings, setSettings] = useState({
    general: {
      companyName: "Rubidsoft Comprehensive IT Services",
      companyEmail: "info@rubidsoft.com",
    ...
    appearance: {
      theme: "light",
      primaryColor: "#3B82F6",
      logo: "https://scontent.fdac157-1.fna.fbcdn.net/v/t39.30808-6/470226643_1247796683055656_8928878490233155816_n.jpg",
      favicon: "/favicon.ico"
    },
    notifications: {
          ...
          {activeTab === "notifications" && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    <h4 className="font-medium text-gray-900">Client Alerts</h4>
                    <p className="text-sm text-gray-600">Get notified about client activities</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={settings.notifications.clientAlerts}
                      onChange={(e) => handleSettingChange("notifications", "clientAlerts", e.target.checked)}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                  </label>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    type="password"
                    value={settings.integrations.paypal}
                    onChange={(e) => handleSettingChange("integrations", "paypal", e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
